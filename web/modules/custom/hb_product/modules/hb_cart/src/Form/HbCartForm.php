  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('hb_cart')->notice('Created new hb_cart %label', $logger_arguments);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The hb_cart %label has been updated.', $message_arguments));
        $this->logger('hb_cart')->notice('Updated hb_cart %label.', $logger_arguments);
        break;
    }

    $form_state->setRedirect('entity.hb_cart.collection');
